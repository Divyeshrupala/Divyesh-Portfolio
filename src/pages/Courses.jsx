  ...
  const courses = [
    {
      ...
      mode: "Online + Offline",
      price: "₹10,000",
      description: "Build responsive websites from scratch using core web technologies including HTML structure, CSS styling, and JavaScript interactivity.",
      eligibility: "B.A, B.Com, B.Tech, BCA, B.Sc. IT graduates/students",
      features: ["HTML5 semantic elements and forms", "CSS Flexbox, Grid, responsive design", "JavaScript DOM manipulation and events"],
    },
    {
      icon: Code2,
      ...
      eligibility: "B.A, B.Com, B.Tech, BCA, B.Sc. IT graduates/students",
      features: ["React components, hooks, state management", "Routing with React Router", "Responsive design with Tailwind/Bootstrap"],
    },
    {
      icon: Server,
      ...
      eligibility: "B.A, B.Com, B.Tech, BCA, B.Sc. IT graduates/students",
      features: ["Node.js/Express or Python Django", "Database design with SQL/NoSQL", "RESTful APIs and JWT authentication"],
    },
    {
      icon: Code2,
