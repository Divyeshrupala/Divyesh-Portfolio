  ...
  const timeline = [
    {
      ...
      description: 'Currently pursuing my Bachelor\'s degree in Computer Engineering, focusing on software development and web technologies.',
    },
    {
      icon: Briefcase,
      title: 'Web Developer',
      subtitle: 'Current Role',
      description: 'Creating interactive and user-friendly websites using modern web technologies and best practices.',
    },
    {
      icon: Code,
      title: 'Full Stack Development',
      subtitle: 'Specialization',
      description: 'Experienced in both frontend and backend development, delivering complete web solutions.',
    },
    {
      icon: Award,
      title: 'Continuous Learning',
      subtitle: 'Philosophy',
      description: 'Always exploring new technologies and methodologies to stay current in the fast-paced tech industry.',
    },
  ];
        ...
        <div className="glass p-8 rounded-2xl mb-16">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              I'm Divyesh Rupala, a 6th-semester Computer Engineering student with a passion for web development. 
              I specialize in creating interactive and user-friendly websites that not only look great but also 
              provide exceptional user experiences.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              My journey in web development started with a curiosity about how websites work, and it has evolved 
              into a dedicated pursuit of mastering both frontend and backend technologies. I believe in writing 
              clean, efficient code and staying updated with the latest industry trends.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              When I'm not coding, you'll find me exploring new technologies, contributing to open-source projects, 
              or sharing knowledge with fellow developers. I'm always excited to take on new challenges and 
